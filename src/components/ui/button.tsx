...
const neoClasses =
  "w-full rounded-full px-3.5 py-5 border-2 relative z-10 text-lg font-bold hover:transform hover:translate-y-[-2px] transition-transform duration-200 focus:outline-none focus:ring-0";
